...
# define KEY_AUX_INSERT					NULL
# define KEY_AUX_HOME					NULL
# define KEY_AUX_PGDN					NULL
# define KEY_AUX_SUPR					NULL
# define KEY_AUX_END					NULL
# define KEY_AUX_PGUP					NULL
# define KEY_AUX_LFAR					0x7B
# define KEY_AUX_UPAR					0x7E
# define KEY_AUX_RTAR					0x7C
# define KEY_AUX_DNAR					0x7D

# define KEY_NUM_LOCK					NULL
# define KEY_NUM_DIV					NULL
# define KEY_NUM_MULT					NULL
# define KEY_NUM_SUB					NULL
# define KEY_NUM_ADD					NULL
# define KEY_NUM_ENTER					NULL
# define KEY_NUM_DEL					NULL
# define KEY_NUM_0						NULL
# define KEY_NUM_1						NULL
# define KEY_NUM_2						NULL
# define KEY_NUM_3						NULL
# define KEY_NUM_4						NULL
# define KEY_NUM_5						NULL
# define KEY_NUM_6						NULL
# define KEY_NUM_7						NULL
# define KEY_NUM_8						NULL
# define KEY_NUM_9						NULL

# define KEY_TAB						0x30
# define KEY_CAPS_LOCK					0x110
# define KEY_MENU						NULL
